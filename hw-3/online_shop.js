...
const first = new Good(1, "T-shirt", "color: black, material: coton", ["S", "M", "L"], 500, true);
const second = new Good(2, "Jeans", "color: blue, material: jeans", ["S", "M", "L"], 1000, true);
const third = new Good(3, "Shirt", "color: white, material: coton", ["S", "M", "L"], 800, true);
const fourth = new Good(4, "Shorts", "color: red, material: coton", ["S", "M", "L"], 700, true);
const fifth = new Good(5, "Sneakers", "color: black, material: lether", ["41", "42", "43"], 2000, true);
